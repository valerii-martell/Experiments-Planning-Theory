...
namespace EPTlab3
{
    [Activity(Label = "Experiment Planning Theory - lab3",
    MainLauncher = true,
    Icon = "@drawable/icon",
    ...
    public class MainActivity : Activity
    {
        protected override void OnCreate(Bundle bundle)
        {
            ...
            double[] x3n = model.x3n;
            double[] my = model.my;
            double[] disp = model.dispersion;
            List<double[]> y = model.y;
            ...
            String[] str = new String[y.Count + 8];
            str[0] = "x1";
            str[1] = "x2";
            str[2] = "x3";
            str[3] = "x1n";
            str[4] = "x2n";
            str[5] = "x3n";
            for (int i = 6; i < (y.Count + 6); i++)
            { str[i] = "y" + (i - 5);
            }
            str[y.Count + 6] = "m(y)";
            str[y.Count + 7] = "dispersion";
